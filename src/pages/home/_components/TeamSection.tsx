...
export default function TeamSection() {
  ...
  if (isLoading) {
    return (
      <section className="bg-[oklch(0.14_0.02_250)] text-white py-16">
  ...
  return (
    <section className="bg-[oklch(0.14_0.02_250)] text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="flex justify-between items-end mb-8 border-b border-[oklch(0.25_0.04_250)] pb-4">
          <div>
            <h3 className="text-3xl font-extrabold uppercase tracking-tight">
              Prvi <span className="text-[oklch(0.65_0.18_250)]">Tim</span>
            </h3>
            <p className="text-[oklch(0.50_0.03_250)] mt-1">Sezona 2025/2026</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/prvi-tim"
              className="hidden sm:flex items-center text-[oklch(0.65_0.18_250)] font-semibold hover:text-white transition-colors ml-2"
            >
        ...
        <div className="mt-6 text-center sm:hidden">
          <Link
            to="/prvi-tim"
            className="inline-flex items-center text-[oklch(0.65_0.18_250)] font-semibold hover:text-white transition-colors"
          >
            Prikaži ceo roster <ArrowRight size={16} className="ml-1" />
          </Link>
        </div>
