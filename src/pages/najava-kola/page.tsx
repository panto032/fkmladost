...
export default function NajavaKolaPage() {
  ...
  return (
    <div className="min-h-screen bg-[oklch(0.97_0.01_228)] font-sans text-foreground">
      ...
      {/* Analytics CTA — light */}
      <section className="bg-[oklch(0.95_0.02_228)] border-y border-[oklch(0.90_0.015_228)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[oklch(0.20_0.04_252)] font-bold text-sm group-hover:text-[oklch(0.69_0.095_228)] transition-colors">
                  Analitika rivala
                </span>
                <span className="text-[oklch(0.55_0.03_252)] text-xs block">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {isLoading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-[oklch(0.55_0.03_252)] text-sm mt-2">
...
function MatchCard({ match }: { match: RoundMatch }) {
  ...
  return (
    <div
      className={`rounded-2xl overflow-hidden border shadow-sm transition-all duration-300 hover:shadow-lg ${
        isOurs
          ? "border-[oklch(0.69_0.095_228)]/40 bg-gradient-to-br from-[oklch(0.94_0.03_228)] to-white ring-1 ring-[oklch(0.69_0.095_228)]/15"
          : "border-[oklch(0.90_0.015_228)] bg-white"
      }`}
    >
      {/* Header bar */}
      <div className={`px-5 py-3 flex items-center justify-between ${
        isOurs ? "bg-[oklch(0.69_0.095_228)]/8" : "bg-[oklch(0.96_0.01_228)]"
      }`}>
        <div className="flex items-center gap-3 text-[oklch(0.50_0.03_252)] text-xs font-semibold">
      ...
      <div className="px-5 py-5">
        <div className="flex items-center justify-between">
          <span className={`font-extrabold text-lg uppercase tracking-tight ${
            isOurs && match.home.toUpperCase().includes("MLADOST")
              ...
              : "text-[oklch(0.20_0.04_252)]"
          }`}>
            {match.home}
          </span>
          <span className="text-[oklch(0.65_0.03_228)] font-bold text-sm mx-3">vs</span>
        ...
        <div className="flex items-center gap-1.5 mt-3 text-[oklch(0.55_0.03_252)] text-xs">
          <MapPin size={12} />
...
function OfficialRow({
  ...
  return (
    <div className="flex items-start gap-1">
      {icon && <span className="text-[oklch(0.55_0.03_252)] mt-px">{icon}</span>}
      <span className="text-[oklch(0.55_0.03_252)] font-semibold shrink-0">{label}:</span>
      <span className="text-[oklch(0.35_0.04_252)] truncate">{value}</span>
    </div>
  );
}
